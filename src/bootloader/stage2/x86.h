...
x86_Disk_GetDriveParams(uint8_t drive, uint8_t *driveTypeOut,
...
bool __attribute__((cdecl))
x86_Disk_Read(uint8_t drive, uint16_t cylinder, uint16_t sector, uint16_t head,
              uint8_t count, void *lowerDataOut);
